 ...
 * @author ASUS
 */
@WebServlet(name = "AscController", urlPatterns = {"/AscController"})
public class AscController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            productDTO dto = null;
            List<productDTO> listProduct = dao.loadProductAsc();
            ...
            log("Erorr at AscController " + e.getMessage());
        } finally {
