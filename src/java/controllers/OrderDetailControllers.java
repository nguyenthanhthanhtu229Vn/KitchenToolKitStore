 ...
 * @author ASUS
 */
@WebServlet(name = "OrderDetailControllers", urlPatterns = {"/OrderDetailControllers"})
public class OrderDetailControllers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("odDetail.jsp").forward(request, response);
        }
    }
